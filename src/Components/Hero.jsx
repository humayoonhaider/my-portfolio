    ...
    <>
      <section className="hero" id="home">
        <span
          ref={welcomeRef}
          id="welcome"
          className={`welcome reveal ${welcomeVisible ? "is-visible" : ""}`}
        >
        ...
        >
          Hi, I'm <span className="important">Muhammad Humayoon.</span>
          <br />I build{" "}

            <span className="important">digital products </span> people <br /> enjoy using.
        ...
        <p
          ref={descRef}
          className={`intro-description reveal ${descVisible ? "is-visible" : ""}`}
        >
              I help ambitious ideas become fast,
       responsive, and polished web products
       ...
       maintainable code.
        ...
        <div
          ref={btnsRef}
          className={`hero-btns reveal ${btnsVisible ? "is-visible" : ""}`}
        >
        ...
        <a
          ref={scrollRef}
          href="#aboutMe"
          className={`btn-secondary scroll-about reveal ${scrollVisible ? "is-visible" : ""}`}
        >
